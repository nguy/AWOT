      SUBROUTINE DOP_SOLN_DRIVER_2(SUBSTITUTE_VP3,N_OBS,USE,DIRCOS_X1,
     $DIRCOS_X2,DIRCOS_X3,VR,SD_VR,VP3_ASSUMED,SD_VP3_ASSUMED,BADDATA,
     $VP1,SD_VP1,VP2,SD_VP2,VP3,SD_VP3)
