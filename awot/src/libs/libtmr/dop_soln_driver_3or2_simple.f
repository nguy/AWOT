      SUBROUTINE DOP_SOLN_DRIVER_3OR2_SIMPLE(SUBSTITUTE_VP3,COMPARE_VP3,
     $N_OBS,USE,DIRCOS_X1,DIRCOS_X2,DIRCOS_X3,VR,SD_VR,VP3_ASSUMED,
...
C  three-component solution.
      ...
      END SUBROUTINE DOP_SOLN_DRIVER_3OR2_SIMPLE
