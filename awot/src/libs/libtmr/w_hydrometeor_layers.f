      SUBROUTINE W_HYDROMETEOR_LAYERS(Z1,TV1,Z2,TV2,Z3,RHO3,N,Z,WP,
...
C  Calculate the the vertical air velocity and its standard deviation at
C  levels.
      DO I=0,N
...
C  Calculate the divergence and its standard deviation in layers.
      CALL DIV_FROM_W_LAYERS(Z1,TV1,Z2,TV2,Z3,RHO3,N,Z,W,SD_W,BADDATA,
     $DIV,SD_DIV)
