      SUBROUTINE LOAD_FLOAT_SIGNIF_RIGHT(A,NSIG,OUTSTRING,NCHAR)
...
C  significant digits.  If OUTSTRING is longer than needed, the
...
C  NCHAR.
     ...
     $   AMOD(B,1.).NE.0.)THEN
      ...
      ELSE
         NDECPT=0
      ENDIF
      CALL LOAD_FLOAT_RIGHT(C,NDECPT,OUTSTRING,NCHAR)
      RETURN
      END
