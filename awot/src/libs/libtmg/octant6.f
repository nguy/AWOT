      SUBROUTINE OCTANT6(A_IN,SD_A_IN,MAXX_IN,MAXY_IN,NX,NY,BADDATA,
     ...
     $POINTS_FOUND,MAX_SEARCH_RADIUS,MAX_VALUES_PER_OCTANT
      ...
      POINTS_FOUND=0
      DO 1 IX_SEARCH=IX-1,IX-MAX_SEARCH_RADIUS,-1
         IF(IX_SEARCH.LT.1)THEN
             RETURN
         ENDIF
         DO 2 IY_SEARCH=IY-1,IY-(IX-IX_SEARCH),-1
            IF(IY_SEARCH.LT.1)THEN
               GOTO 3
            ENDIF
