      SUBROUTINE HOLE_FILL_EXTEND_1D_DRIVER12(A_IN,SD_A_IN,CANDIDATE,
     $MAXX_IN,MAXY_IN,MAXZ_IN,NX,NY,NZ,BADDATA,MAX_UNOCCUPIED_SIDES,
...
C  subroutine HOLE_FILL_EXTEND_1D, which is applied in the third
C  dimension.
...
3           CONTINUE
            CALL HOLE_FILL_EXTEND_1D(A_1D,SD_A_1D,CANDIDATE_1D,NZ,
     $      BADDATA,MAX_UNOCCUPIED_SIDES,MAX_SEARCH_RADIUS,
     $      MIN_VALUES_PER_SIDE,MAX_VALUES_PER_SIDE,A_1D,SD_A_1D,
     $      POINTS_MISSING_COLUMN,POINTS_FILLED_COLUMN)
            DO 4 IZ=1,NZ
