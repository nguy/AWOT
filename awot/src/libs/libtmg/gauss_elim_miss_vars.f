      SUBROUTINE GAUSS_ELIM_MISS_VARS(A,A_DIM_1,N,B,B_DIM_1,N_PROBLEMS,
     $CHECK_SINGULAR,SINGULAR_THRESHOLD,WRITE_MODE,SOLUTION,
     $SOLUTION_DIM_1,SOLUTION_EXISTS,SUCCESS)
...
C  Obtain the solution by Gaussian elimination to upper triangular form
C  and back-substitution.
      CALL GAUSS_ELIM(A_PACKED,N,NUM_NON_ZERO_COLS,B_PACKED,N,
