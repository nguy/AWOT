      SUBROUTINE HOLE_FILL_1D(A_IN,SD_A_IN,CANDIDATE,NX,BADDATA,
...
C  Perform two passes of hole filling.
      CALL HOLE_FILL_1D_ONE_PASS(A_IN,SD_A_IN,CANDIDATE,NX,BADDATA,
     $MAX_UNOCCUPIED_SIDES,MAX_SEARCH_RADIUS,MIN_VALUES_PER_SIDE,
     $MAX_VALUES_PER_SIDE,A_OUT,SD_A_OUT,POINTS_MISSING_PASS,
     $POINTS_FILLED_PASS)
      POINTS_MISSING=POINTS_MISSING_PASS
      POINTS_FILLED=POINTS_FILLED_PASS
      CALL HOLE_FILL_1D_ONE_PASS(A_OUT,SD_A_OUT,CANDIDATE,NX,BADDATA,
     $MAX_UNOCCUPIED_SIDES,MAX_SEARCH_RADIUS,MIN_VALUES_PER_SIDE,
     $MAX_VALUES_PER_SIDE,A_OUT,SD_A_OUT,POINTS_MISSING_PASS,
     $POINTS_FILLED_PASS)
