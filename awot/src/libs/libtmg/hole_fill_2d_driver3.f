      SUBROUTINE HOLE_FILL_2D_DRIVER3(A_IN,SD_A_IN,CANDIDATE,MAXX_IN,
     $MAXY_IN,MAXZ_IN,DELX,DELY,NX,NY,NZ,BADDATA,
...
C  HOLE_FILL_2D, which is applied in the first two dimensions.
...
C  Loop through the planes and fill data holes.
      ...
      POINTS_FILLED=0
      DO 1 IZ=1,NZ
         CALL HOLE_FILL_2D(A_IN(1,1,IZ),SD_A_IN(1,1,IZ),
